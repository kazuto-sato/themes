...
?>      
                <ul class="side-nav">
                <li class="go-home-btn side-li-box"><a href="<?php echo home_url('/');?>">
                ...
                <li class="go-recipe-btn side-li-box"><a href="<?php echo home_url('/receipe');?>">
                ...
                <li class="go-vocaburaly-btn side-li-box"><a href="<?php echo home_url('/words');?>">
                ...
                <?php /*
                <li class="go-home-btn side-li-box"><a href="<?php ?>">
